    ...
    <div className="container py-8 lg:py-12 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Review your recent payment activity and statuses.
        </p>
      </div>
      ...
      <div className="grid gap-4">
        {payments.map((payment) => (
          ...
          >
            ...
            <span
              className={`px-2.5 py-1 rounded-full text-xs font-medium ${payment.status === "Paid" ? "bg-success/10 text-success" : "bg-warning/10 text-warning"}`}
            >
              {payment.status}
            </span>
          </div>
